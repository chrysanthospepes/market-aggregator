...
from comparison.review_pages import (
    build_listing_report_entry as _build_listing_report_entry,
    build_listing_report_queue_context,
    build_match_review_queue_context,
    listing_report_candidate_products as _listing_report_candidate_products,
    listing_report_default_candidate_query as _listing_report_default_candidate_query,
)
...
def match_review_queue(request):
    ...
    return render(
        ...
        build_match_review_queue_context(request),
    )
...
def listing_report_queue(request):
    return render(
        ...
        build_listing_report_queue_context(request),
    )
